...
export function ThermostatData(props: { data: ThermostatData }) {
    const { data } = props;
    return (
        <Card className="w-[450px]">
            ...
            <CardContent className="flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500">
                            Limit: {data.setPointLowerLimit}°C -{" "}
                            {data.setPointUpperLimit}°C
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span
                        className={`rounded-full px-3 py-1 text-sm ${getSystemModeColor(
                            data.systemMode,
                        )}`}
                    >
                        {data.systemMode
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span
                        className={`rounded-full px-3 py-1 text-sm ${getFanStatusColor(
                            data.fanStatus,
                        )}`}
                    >
                        {data.fanStatus
